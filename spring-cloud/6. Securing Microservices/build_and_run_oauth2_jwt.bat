...
REM Build and Run Zuul Server 2 (at port 2301)
echo.
echo ------------------------------------------
echo Build and Run Zuul Server 2 (at port 2301)
echo ------------------------------------------
cd ..\CubicZuulServer-2
start mvn clean spring-boot:run
timeout /T 10
...
REM Build and Run Auth Services 2 (at port 2501)
echo.
echo --------------------------------------------
echo Build and Run Auth Services 2 (at port 2501)
echo --------------------------------------------
cd ..\CubicAuthServer-2
start mvn clean spring-boot:run
timeout /T 10
